...
(define tests
  (test-suite
   ...
   ; vector-assoc test
   (check-equal? (vector-assoc "a" (vector (cons 2 1) (cons 3 1) (cons "a" 1) (cons 5 1))) (cons "a" 1) "vector-assoc test")
   (check-equal? (vector-assoc 5 (vector (cons 4 3) 5 (cons -5 3))) #f "vector-assoc test 2")
   ; cached-assoc tests
