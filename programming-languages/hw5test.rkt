...
(define tests
  (test-suite
   ...
   ;; call test
   (check-equal? (eval-exp (call (closure '() (fun "addx" "x" (add (var "x") (int 7)))) (int 1))) (int 8) "call test")
   
   ;;snd test
   (check-equal? (eval-exp (snd (apair (int 1) (int 2)))) (int 2) "snd test")
   
   ;; isaunit test
   (check-equal? (eval-exp (isaunit (closure '() (fun "test" "x" (aunit))))) (int 0) "isaunit test")
